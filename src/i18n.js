...
export const UI = {
  it: {
    ...
    sp_range: 'Gittata', rng_ft: 'Piedi (ft)', rng_touch: 'Contatto', rng_self: 'Se stesso', sp_range_val: 'Piedi',
    ...
    sp_upcast: 'Upcast per slot', sp_upcast_hint: '(dadi extra per slot superiore, es. 1d6)',
  ...
  en: {
    ...
    sp_range: 'Range', rng_ft: 'Feet (ft)', rng_touch: 'Touch', rng_self: 'Self', sp_range_val: 'Feet',
    ...
    sp_upcast: 'Upcast per slot', sp_upcast_hint: '(extra dice per higher slot, e.g. 1d6)',
