...
export const UI = {
  it: {
    ...
    theme_label: 'Tema', theme_taf: '⚒️ TAF', theme_avernus: '🌋 Avernus', theme_spelljammer: '🚀 Spelljammer', theme_barovia: '🦇 Barovia', theme_parchment: '📜 Pergamena', theme_contrast: '◐ Alto contrasto',
    ...
    ph_avatar: 'https://... oppure worlds/mio-mondo/img/mostro.webp', ph_token: 'vuoto = usa l\'avatar',
    ...
    aa_enable: 'Attiva animazione',
    aa_menu: 'Tipo (menu A-A)', aa_menu_hint: '(come nel modulo)',
    aam_ontoken: 'Sul token (On Token)', aam_melee: 'Mischia (Melee)', aam_range: 'A distanza (Range)', aam_aura: 'Aura', aam_templatefx: 'Su area / Preset', aa_radius: 'Raggio',
    aa_sound: 'Suono', aa_sound_file: 'File audio (percorso server)', aa_sound_vol: 'Volume (0-1)',
    // On-Use Macros (Midi-QOL)
    ou_legend: 'On-Use Macros (Midi)', ou_legend_hint: '(macro eseguite durante l\'uso — opzionale)',
    ou_add: '➕ Macro', ou_remove: 'Rimuovi riga',
    ou_macro_ph: 'NomeMacro · ItemMacro · function.percorso',
    ou_macro_title: 'Nome di una macro del mondo, "ItemMacro" (macro DIME dell\'item) o function.percorso.funzione',
    ou_note: 'ℹ Formato Midi-QOL: ogni riga diventa "[timing]nome" in flags.midi-qol.onUseMacroName. La macro deve esistere nel mondo (o essere una funzione globale).',
    ...
    // Tab + calcolatore DPR
    tab_npc: '🐲 Mostro / NPC', tab_dpr: '📊 Calcolatore DPR', tab_info: 'ℹ️ Info & Macro',
    // Blocco Extra (DAE + Midi + A-A raggruppati)
    xt_legend: 'Extra: DAE, Midi, A-A',
    // Tab Info & Macro
    info_how_title: 'Come si usa', info_bye: '⚔️ Buona preparazione, e che i tuoi dadi rotolino sempre a tuo favore!',
    info_how_html: '<p>Compila i campi della scheda (<b>Mostro</b>, <b>Oggetto</b> o <b>Incantesimo</b>): l\'anteprima JSON si aggiorna in tempo reale. Quando sei pronto premi <b>Esporta</b> per scaricare il file, oppure <b>Aggiungi alla collezione</b> per raccoglierne tanti in un unico file.</p><p>Per importare in Foundry copia una volta la <b>macro importer</b> (qui sotto o dal pulsante nella scheda), incollala in una macro di tipo <i>Script</i>, e da lì incolla il JSON: Actor, Oggetti e Incantesimi vengono smistati e creati in automatico.</p><p>I campi opzionali (effetti DAE, animazioni A-A, macro Midi) sono raccolti nel menù <b>Extra</b>, chiuso finché non ti serve.</p>',
    info_tips_title: 'Consigli rapidi',
    info_tips_html: '<ul><li>Le immagini devono finire in .webp/.png/.jpg; gli URL esterni si vedono in scheda ma spesso non in mappa (CORS): meglio caricarle nel server.</li><li>Nei danni usa gli id inglesi: <code>2d8 + @mod piercing, 8d8 fire</code>.</li><li>Le animazioni A-A cercano i path della libreria <b>free</b> di JB2A (forme corte: “slash”, “claw”, “fireball”).</li><li>Rivedi sempre la scheda prima di esportare: gli strumenti accelerano, il controllo è tuo.</li></ul>',
    info_macros_title: '🎲 Macro utili', info_macros_hint: 'Copia il codice, incollalo in una macro Foundry di tipo <i>Script</i> e regola il blocco CONFIG in cima.', info_copy: 'Copia',
    mp_importer: 'Importer di Actor / Oggetti / Spell', mp_importer_desc: 'La macro principale: incolli il JSON del Forge e crea tutto, smistando Actor e Item nelle rispettive cartelle.',
    mp_cinematic: 'Scena cinematica', mp_cinematic_desc: 'Mostra un\'immagine a tutto schermo e fa partire una traccia dalla playlist nello stesso istante, precaricando entrambe per evitare ritardi.',
    mp_transform: 'Trasformazione token', mp_transform_desc: 'Sostituisce il token selezionato con un\'altra forma (suono + animazione opzionali). Rilanciandola ripristina il token originale e ferma l\'animazione.',
    mp_groupsave: 'Tiro salvezza di gruppo', mp_groupsave_desc: 'Tutti i token selezionati tirano lo stesso TS contro una CD; il risultato con ✅/❌ appare in chat.',
    mp_condition: 'Condizione ai selezionati', mp_condition_desc: 'Applica o rimuove una condizione (prone, avvelenato, spaventato…) a tutti i token selezionati con un click.',
    mp_massdamage: 'Danno / cura di massa', mp_massdamage_desc: 'Chiede una quantità e la applica come danno o cura a tutti i token selezionati insieme.',
  ...
  en: {
    ...
    theme_label: 'Theme', theme_taf: '⚒️ TAF', theme_avernus: '🌋 Avernus', theme_spelljammer: '🚀 Spelljammer', theme_barovia: '🦇 Barovia', theme_parchment: '📜 Parchment', theme_contrast: '◐ High contrast',
    ...
    ph_avatar: 'https://... or worlds/my-world/img/monster.webp', ph_token: 'empty = use the avatar',
    ...
    aa_enable: 'Enable animation',
    aa_menu: 'Type (A-A menu)', aa_menu_hint: '(as in the module)',
    aam_ontoken: 'On Token', aam_melee: 'Melee', aam_range: 'Range', aam_aura: 'Aura', aam_templatefx: 'On area / Preset', aa_radius: 'Radius',
    aa_sound: 'Sound', aa_sound_file: 'Audio file (server path)', aa_sound_vol: 'Volume (0-1)',
    // On-Use Macros (Midi-QOL)
    ou_legend: 'On-Use Macros (Midi)', ou_legend_hint: '(macros run during the use — optional)',
    ou_add: '➕ Macro', ou_remove: 'Remove row',
    ou_macro_ph: 'MacroName · ItemMacro · function.path',
    ou_macro_title: 'Name of a world macro, "ItemMacro" (the item\'s DIME macro) or function.path.fn',
    ou_note: 'ℹ Midi-QOL format: each row becomes "[timing]name" in flags.midi-qol.onUseMacroName. The macro must exist in the world (or be a global function).',
    ...
    tab_npc: '🐲 Monster / NPC', tab_dpr: '📊 DPR Calculator', tab_info: 'ℹ️ Info & Macros',
    // Extra block (DAE + Midi + A-A grouped)
    xt_legend: 'Extra: DAE, Midi, A-A',
    // Info & Macros tab
    info_how_title: 'How to use', info_bye: '⚔️ Happy prepping, and may your dice always roll in your favor!',
    info_how_html: '<p>Fill in the sheet fields (<b>Monster</b>, <b>Item</b> or <b>Spell</b>): the JSON preview updates live. When ready, press <b>Export</b> to download the file, or <b>Add to collection</b> to gather many into one file.</p><p>To import into Foundry, copy the <b>importer macro</b> once (below or from the button on the sheet), paste it into a <i>Script</i> macro, then paste the JSON there: Actors, Items and Spells are sorted and created automatically.</p><p>Optional fields (DAE effects, A-A animations, Midi macros) live in the <b>Extra</b> menu, collapsed until you need them.</p>',
    info_tips_title: 'Quick tips',
    info_tips_html: '<ul><li>Images must end in .webp/.png/.jpg; external URLs show on the sheet but often not on the map (CORS): better to upload them to the server.</li><li>For damage use English ids: <code>2d8 + @mod piercing, 8d8 fire</code>.</li><li>A-A animations search the <b>free</b> JB2A library paths (short forms: “slash”, “claw”, “fireball”).</li><li>Always review the sheet before exporting: the tools speed you up, the check is yours.</li></ul>',
    info_macros_title: '🎲 Useful macros', info_macros_hint: 'Copy the code, paste it into a Foundry <i>Script</i> macro and tweak the CONFIG block at the top.', info_copy: 'Copy',
    mp_importer: 'Actor / Item / Spell importer', mp_importer_desc: 'The main macro: paste the Forge JSON and it creates everything, sorting Actors and Items into their folders.',
    mp_cinematic: 'Cinematic scene', mp_cinematic_desc: 'Shows a fullscreen image and starts a playlist track at the same instant, preloading both to avoid hitches.',
    mp_transform: 'Token transformation', mp_transform_desc: 'Swaps the selected token for another form (optional sound + animation). Re-running it restores the original token and stops the animation.',
    mp_groupsave: 'Group saving throw', mp_groupsave_desc: 'All selected tokens roll the same save against a DC; the result with ✅/❌ appears in chat.',
    mp_condition: 'Condition on selected', mp_condition_desc: 'Applies or removes a condition (prone, poisoned, frightened…) on all selected tokens with one click.',
    mp_massdamage: 'Mass damage / heal', mp_massdamage_desc: 'Asks for an amount and applies it as damage or healing to all selected tokens at once.',
